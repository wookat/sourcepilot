...
func TestCreateStoresHashOnly(t *testing.T) {
	...
	res, err := svc.Create(context.Background(), 1, "claude-desktop", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestCreateValidation(t *testing.T) {
	svc := &mcptoken.Service{DB: openTestDB(t)}
	if _, err := svc.Create(context.Background(), 1, "  ", nil); err == nil {
		t.Fatal("expected error for empty name")
	}
	if _, err := svc.Create(context.Background(), -1, "x", nil); err == nil {
		t.Fatal("expected error for negative tenant")
	}
	// Tenant 0 stays valid for legacy single-tenant data.
	if _, err := svc.Create(context.Background(), 0, "legacy", nil); err != nil {
...
func TestAuthenticate(t *testing.T) {
	svc := &mcptoken.Service{DB: openTestDB(t)}
	res, err := svc.Create(context.Background(), 7, "inspector", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRevokeBlocksAuth(t *testing.T) {
	svc := &mcptoken.Service{DB: openTestDB(t)}
	res, err := svc.Create(context.Background(), 1, "to-revoke", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTenantIsolation(t *testing.T) {
	svc := &mcptoken.Service{DB: openTestDB(t)}
	a, err := svc.Create(context.Background(), 1, "tenant-a", nil)
	if err != nil {
		t.Fatal(err)
	}
	if _, err := svc.Create(context.Background(), 2, "tenant-b", nil); err != nil {
		t.Fatal(err)
	}
