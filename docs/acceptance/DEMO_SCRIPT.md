# R123 完整演示动线脚本（30 分钟 · Docker 全栈 + seed:demo:full，R128 增补自动化新动作，R132 增补 R128–R131 交付，R136 增补 R132–R135 交付，R141 增补 R136–R140 交付，R148 增补 R144–R147 交付，R153 增补 R148–R152 交付）
...
- R153 时点开放 API（#308）与买家消息多语言（#309）尚未合入 main：演示前需基于 main 叠加 #303/#305/#307/#308/#309 分支构建（`docker compose -f docker-compose.full.yml up -d --build`；#304/#306 纯文档不影响构建）；注意 #309 与 #308 在 `docs/module-map.md`、`docs/progress/R152.md`、`tests/contracts/api-contracts.test.ts` 存在可解冲突（契约受保护端点数合并后为 122），建集成分支时需手工解决；全部合入后基于最新 main 构建即可。
