...
- R153 时点开放 API（#308）与买家消息多语言（#309）尚未合入 main：演示前需基于 main 叠加 #303/#305/#307/#308/#309 分支构建（`docker compose -f docker-compose.full.yml up -d --build`；#304/#306 纯文档不影响构建）；全部合入后基于最新 main 构建即可。
